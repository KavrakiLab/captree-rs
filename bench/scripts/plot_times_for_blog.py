...
USAGE:
```sh
cargo run --release --bin perf_plots
python3 plot_times_for_blog.py construct.csv mixed.csv collides.csv no_collides.csv
```
"""
...
def plot_build_times(fname: str):
    ...
    plt.title("Scaling of CC structure construction time")
    plt.savefig("{title}_")
